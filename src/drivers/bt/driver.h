...
#define BT_SECT_PASS "bt passing"
...
#define BT_ATT_DIST "dist"
#define BT_ATT_ACCEL "accel"
...
class Driver {
	...
	private:
		...
		float x1,y1,currentspeed; //location
		...
		float MU_FACTOR;				// [-]
		float PASS_DIST; 	//distance to allow passing (reduce accel)
		float ACCEL_DEC; 	//what factor to change acceleration by
