/***************************************************************************
    ...
    email                : torcs@free.fr
    version              : $Id: maintrackgen.cpp,v 1.5.2.3 2008/12/31 03:53:57 berniw Exp $
...
void usage(void)
{
    fprintf(stderr, "Terrain generator for tracks $Revision: 1.5.2.3 $ \n");
...
void init_args(int argc, char **argv)
{
	...
	case 0:
		...
		break;
	    case 1:
		printf("Terrain generator for tracks $Revision: 1.5.2.3 $ \n");
		exit(0);
		break;
	    default:
		usage();
